...
const Footer = () => {
    return (
        <div className='bg-gradient-to-r from-[#1e2b47] to-[#151e31]'>
            <footer className="py-16 text-white container mx-auto">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1400px] mx-auto px-3">
                    <div className="flex flex-col space-y-4">
                        <h2 className="font-semibold text-gray-200 uppercase">SERVICES</h2>
                    ...
                    <div className="flex flex-col space-y-4">
                        <h2 className="font-semibold text-gray-200 uppercase">Company</h2>
                        <div className="flex flex-col space-y-2 text-sm text-[#cfcfcf]">
                            <Link to="/">
                                About us
                            </Link>
                    ...
                    <div className="flex flex-col space-y-4">
                        <h2 className="font-semibold text-gray-200 uppercase">Legal</h2>
                        <div className="flex flex-col space-y-2 text-sm text-[#cfcfcf]">
                            <Link to="/">
                                Terms of use
                            </Link>
